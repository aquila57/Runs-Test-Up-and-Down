/* runsine.c - Sine Distribution Runs Up and Down  Version 0.1.0 */
...
/* using a sine wave distribution */
...
double gen_dbl(xxfmt *xx)
   ...
   /* generate a sine of x from zero to one */
   sinx = sin(radian);
   /* return a sine of x from zero to one */
   return(sinx);
   } /* gen_dbl */
